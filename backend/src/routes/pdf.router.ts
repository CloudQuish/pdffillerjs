...
PDFRouter.post("/get-fillable-fields-by-url", PDFController.get_fillable_fields);
PDFRouter.post("/get-fillable-fields-by-buffer", PDFController.get_fillable_fields_by_buffer);
