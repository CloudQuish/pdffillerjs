...
export const email_templates: IEmailTemplates = {
  user_notification: {
    template_id: process.env.USER_NOTIFICATION_TEMPLATE_ID_PDF_REVESH || "",
    variables_needed: ["api_key", "first_name", "support_email"],
  },
};
